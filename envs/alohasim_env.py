...
from envs.aloha_constants import DT, XML_DIR, START_ARM_POSE
from envs.aloha_constants import PUPPET_GRIPPER_POSITION_UNNORMALIZE_FN
from envs.aloha_constants import MASTER_GRIPPER_POSITION_NORMALIZE_FN
from envs.aloha_constants import PUPPET_GRIPPER_POSITION_NORMALIZE_FN
from envs.aloha_constants import PUPPET_GRIPPER_VELOCITY_NORMALIZE_FN
...
class BimanualViperXTask(base.Task):
    ...
    def get_observation(self, physics):
        ...
        obs['images']['left_pillar'] = physics.render(height=64, width=64, camera_id='left_pillar')
        obs['images']['wrist64'] = physics.render(height=64, width=64, camera_id='wrist64')
