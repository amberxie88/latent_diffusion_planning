...
class ALOHASimDataset(torch.utils.data.IterableDataset):
    ...
    def get_item(self, index):
        ...
        return self._get_batch(demo_start_index, seq_start_index, seq_end_index, n_pad_start, n_pad_end)

    def _get_batch(self, demo_start_index, seq_start_index, seq_end_index, n_pad_start, n_pad_end):
        batch = dict()
    ...
    def sample_traj(self, ep_id):
        ...
        batch = self._get_batch(demo_start_index, demo_start_index, demo_end_index, 0, 0)
...
class ALOHASimData:
    ...
    def __init__(self, name, train_path, eval_path,
        ...
        obs_keys = meta.lowdim_obs + meta.rgb_obs
        self.ds_kwargs = dict(
            obs_keys=obs_keys,
    ...
    def train_dataset(self):
        if self._train_dataset is None:
            ...
            self._train_dataset = ALOHASimDataset(**self.ds_kwargs)
    ...
    def val_dataset(self):
        if self._val_dataset is None:
            ...
            self._val_dataset = ALOHASimDataset(**self.ds_kwargs)
