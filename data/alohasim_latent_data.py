...
class ALOHASimLatentDataset(torch.utils.data.IterableDataset):
    def __init__(self, hdf5_path, latent_path, obs_keys, rgb_keys, dataset_keys,
        ...
        super(ALOHASimLatentDataset, self).__init__()
    ...
    def normalize_obs(self):
        ...
        obs_traj['actions'] = self.hdf5_file[f"data/{ep}/actions"][()].astype('float32')
...
class ALOHASimData:
    ...
    def __init__(self, name, train_path, eval_path,
                ...
                obs_horizon, seq_length, hdf5_use_swmr, meta, env_params):
        self.name = name
        ...
        obs_keys = meta.lowdim_obs + meta.rgb_obs # not sure if this is correct
        self.ds_kwargs = dict(
            obs_keys=obs_keys,
    ...
    def train_dataset(self):
        if self._train_dataset is None:
            ...
            self._train_dataset = ALOHASimLatentDataset(**self.ds_kwargs)
